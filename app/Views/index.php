...
<head>
  ...
  <title>Sekolah Kolaborasi</title>
      ...
      <div class="row justify-content-between">
        <div class="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center">
          <div data-aos="zoom-out">
            <h1>Sekolah Kolaborasi</h1>
            <h2>“Setiap anak memiliki kesempatan memperoleh pendidikan yang berkualitas tanpa melihat ia bersekolah di sekolah negeri atau swasta.”</h2>
            <div class="text-center text-lg-start">
              <a href="#tujuan" class="btn-get-started scrollto">Tujuan</a>
            </div>
          </div>
        </div>
        <div class="col-lg-4 order-1 order-lg-2 hero-img" data-aos="zoom-out" data-aos-delay="300">
          <img src="assets/img/hand-puzzle.png" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
  ...
  <main id="main">
    ...
    <section id="tujuan" class="tujuan">
      <div class="container">
        ...
        <div class="row">
          <div class="col-xl-6 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5" data-aos="fade-left">
            <h3>Tujuan Sekolah Kolaborasi</h3>
          ...
          <div class="col-xl-6 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5" data-aos="fade-left">
            <h3>Tujuan Jakarta Sekolah Kolaborasi</h3>
            <!-- <p>Esse voluptas cumque vel exercitationem. Reiciendis est hic accusamus. Non ipsam et sed minima temporibus laudantium. Soluta voluptate sed facere corporis dolores excepturi. Libero laboriosam sint et id nulla tenetur. Suscipit aut voluptate.</p> -->
            ...
            <table class="table">
              <thead>
                <tr>
                  ...
                  <th scope="col">Sekolah Induk</th>
                  <th scope="col">Sekolah Mitra</th>
                </tr>
              </thead>
              <tbody>
